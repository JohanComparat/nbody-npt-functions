...
rhomDS = cosmo.critical_density(0.).to(uu.solMass/(uu.Mpc)**3.)/(cosmo.H(0.)/(100*uu.km/(uu.Mpc*uu.s)))**1.
ds80=n.loadtxt(join("..", "..", "DarkSkies", "M200b","ds14_a_halos_1.0000.hist8_m200b"),  unpack=True)
ds16=n.loadtxt(join("..", "..", "DarkSkies", "M200b","ds14_g_1600_4096_m200b_1.0000.hist8_m200b"),  unpack=True)

m200c_ds_80=ds80[0]/cosmo.Om0
logsigM_80 = n.log10(1/ds80[2])
f_DS_80 = n.log10( m200c_ds_80 * ds80[1] / abs(ds80[3])/ rhomDS.value )
m200c_ds_16=ds16[0]/cosmo.Om0
logsigM_16 = n.log10(1/ds16[2])
f_DS_16 = n.log10( m200c_ds_16 * ds16[1] / abs(ds16[3]) / rhomDS.value )
...
def plotData(qty = 'M200c', cos = "cen", zmin = -0.01, zmax = 2.3):
	...
	sc1=p.scatter(logsigM1, log_MF , c=data["redshift"][ok], s=5, marker='o',label="MD cen data", rasterized=True, vmin=zmin, vmax = zmax)
	sc1.set_edgecolor('face')
	p.plot(logsigM_80,f_DS_80, 'b+', label='Skillman 16')
	p.plot(logsigM_16,f_DS_16, 'r+', label='Skillman 16')
	...
	p.figure(0,(6,6))
	p.axes([0.17,0.17,0.75,0.75])
	sc1=p.scatter(log_m200c, log_MF, c=data["redshift"][ok], s=5, marker='o',label="MD cen data", rasterized=True, vmin=zmin, vmax = zmax)
	print k16x, k16y
	#p.plot(k16x, n.log10(k16y), 'k+', label='Klypin 16')
	p.plot(n.log10(m200c_ds_80),f_DS_80, 'b+', label='Skillman 16')
	p.plot(n.log10(m200c_ds_16),f_DS_16, 'r+', label='Skillman 16')
	sc1.set_edgecolor('face')
	cb = p.colorbar(shrink=0.8)
	cb.set_label("redshift")
