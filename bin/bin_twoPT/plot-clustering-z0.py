...
for vmin in vmins:
	list44 = n.array(glob.glob(join("..","MD_1Gpc","halo_bias","clustering","hlist_1.00000_vmax_"+vmin+"*rmax_050_xiR.pkl")))
	list42 = n.array(glob.glob(join("..","MD_0.4Gpc","halo_bias","clustering","hlist_1.00000_vmax_"+vmin+"*rmax_050_xiR.pkl")))
	list41 = n.array(glob.glob(join("..","MD_2.5Gpc","halo_bias","clustering","hlist_80_vmax_"+vmin+"*rmax_50_xiR.pkl")))
	list43 = n.array(glob.glob(join("..","MD_4Gpc","halo_bias","clustering","hlist_128_vmax_"+vmin+"*rmax_050_xiR.pkl")))
	list40=n.hstack((list41, list42, list43, list44))
	list40.sort()
	print list40
	p.figure(0,(11,6))
	...
	gl.set_frame_on(False)
	p.grid()
	p.savefig(join("..","clustering","a_1.00000","xi-lt50-MD-"+vmin+".png"))
	p.clf()
