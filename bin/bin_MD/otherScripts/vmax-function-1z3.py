...
chi2fun = lambda p0 : n.sum((vfGbis0(vmax,redshift,p0) - yData)**2. / yDataErr**2. )/len(yDataErr)
...
p1 = n.array([ 0.73575868, -0.17861551,  -0.32736035,  0.221566, 0.16587088])#4, 0.6, 2.85, -0.1, 1.77, -0.03, 0., -2.8, -0.1 ])
...
#ax.set_yscale('log')
#ax.set_zscale('log')
p.savefig(Pdir + "vmax-function-3d-0-z-4.pdf")
p.clf()

fig = p.figure(1,(9,9))
ax = fig.add_subplot(111, projection='3d')

sc1 = ax.scatter(n.log10(xData_04),z_04,yData_04/vfGbis0(xData_04,z_04,res.x), s=n.ones_like(z_04)*3, c='r', marker='o',label="SMD")
sc1.set_edgecolor('face')

sc1 = ax.scatter(n.log10(xData_10),z_10,yData_10/vfGbis0(xData_10,z_10,res.x), s=n.ones_like(z_10)*3, c='c', marker='v',label="MDPL")
sc1.set_edgecolor('face')

sc1 = ax.scatter(n.log10(xData_25),z_25,yData_25/vfGbis0(xData_25,z_25,res.x), s=n.ones_like(z_25)*3, c='m', marker='s',label="BigMD")
sc1.set_edgecolor('face')

sc1 = ax.scatter(n.log10(xData_40),z_40,yData_40/vfGbis0(xData_40,z_40,res.x), s=n.ones_like(z_40)*3, c='b', marker='p',label="HMD")
sc1.set_edgecolor('face')
...
#ax.set_yscale('log')
#ax.set_zscale('log')
p.savefig(Pdir + "vmax-function-3d-dataOmodel-0-z-4.pdf")
p.show()
