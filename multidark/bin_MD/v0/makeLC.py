...
outputName = wdir + boxDir + "MD_2.5Gpc_lc_square_highRes_z0.88.txt"
Melement = 23593750000.0

lc1=LightconeSquare(zMean=0.88,Lbox=2500.0 * uu.Mpc,wdir=wdir,boxDir=boxDir,snl=snl,zsl=zs,zArray=zArray,Hbox=Hbox,outputName=outputName,Melement = Melement)
