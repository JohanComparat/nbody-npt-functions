...
lcDir = boxDir + "lc_square_0.1z1.4/"
...
print snl
zs=zInter[ids]
zArray=n.arange(0.05,2.4,1e-4)
Hbox=67.77 * uu.km / (uu.s * uu.Mpc)
outputName = lcDir + "snapshot.txt"
Melement = 23593750000.0

lc1=LightconeSquare(zMean=0.65,Lbox=2500.0 * uu.Mpc,wdir=wdir,boxDir=boxDir,lcDir=lcDir ,snl=snl, zsl=zs,zArray=zArray,Hbox=Hbox,outputName=outputName,Melement = Melement)
