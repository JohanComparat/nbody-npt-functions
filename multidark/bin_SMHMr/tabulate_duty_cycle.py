...
p.plot((logMs_low+ logMs_up)/2., n.log10(dN_dVdlogM*0.6777**3./n.log(10)), label='MD10 out z=0.3', lw=2)
logMs_low, logMs_up, counts, dN_dVdlogM = n.loadtxt(glob.glob(os.path.join("..", "..", "data", "out*0.4Gpc*_SMF.txt"))[0], unpack=True)
p.plot((logMs_low+ logMs_up)/2., n.log10(dN_dVdlogM*0.6777**3./n.log(10)), label='MD04 out z=0.3', lw=2)
...
logMs_low, logMs_up, counts, dN_dVdlogM = n.loadtxt(glob.glob(os.path.join("..", "..", "data", "out*0.4Gpc*_SMF.txt"))[0], unpack=True)
MD_SMF = interp1d((logMs_low+ logMs_up)/2., n.log10(dN_dVdlogM*0.6777**3./n.log(10)))
