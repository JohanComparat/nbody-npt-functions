...
def create_plots(env='MD04', file_type="out"):
	...
	p.plot(xb[sel], n.sum(H420, axis=0)[sel]/all_halos, label= 'L>42.0')
	p.plot(xb[sel], n.sum(H425, axis=0)[sel]/all_halos, label= 'L>42.5')
	p.plot(xb[sel], n.sum(H430, axis=0)[sel]/all_halos, label= 'L>43.0')
	p.plot(xb[sel], n.sum(H435, axis=0)[sel]/all_halos, label= 'L>43.5')
