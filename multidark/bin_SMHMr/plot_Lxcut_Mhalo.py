...
def create_plots(env='MD04'):
	...
	for fileN in fileList:
		...
		p.figure(1, (6,6))
		p.hist(hd['mvir'][cut420], bins=bins, normed =True, label='L>42.0')
		p.hist(hd['mvir'][cut425], bins=bins, normed =True, label='L>42.5')
		p.hist(hd['mvir'][cut430], bins=bins, normed =True, label='L>43.0')
		p.hist(hd['mvir'][cut435], bins=bins, normed =True, label='L>43.5')
