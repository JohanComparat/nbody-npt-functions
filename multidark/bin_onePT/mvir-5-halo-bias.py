...
p.errorbar(-n.log10(s_mean[sel]), b[sel], xerr=abs(n.log10(s_high[sel]) -n.log10(s_low[sel]) )/2., yerr = bErr[sel], rasterized=True, fmt='none', label='M25')
...
p.grid()
p.savefig(join(os.environ['MVIR_DIR'],"halo_bias.png"))
p.clf()
